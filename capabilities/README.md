...
- **Specification:** per AMWA BCP-004-01
  - **Type:** boolean
  - **Target:** coded video or audio Flow `constant_bit_rate` (defined in the [Flow Attributes](../flow-attributes/#constant-bit-rate) register)
- **Applicability:** AMWA IS-04
...
- **Specification:** per AMWA BCP-004-01
  ...
  - **Target:** (a) video or audio Flow `profile` (defined in the [Flow Attributes](../flow-attributes/#profile) register), (b) depending on the media type, an SDP attribute `a=fmtp:` format-specific parameter, e.g. `profile`
- **Applicability:** AMWA IS-04
...
- **Specification:** per AMWA BCP-004-01
  - **Type:** string (values depending on the media type)
  - **Target:** (a) video or audio Flow `level` (defined in the [Flow Attributes](../flow-attributes/#level) register), (b) depending on the media type, an SDP attribute `a=fmtp:` format-specific parameter, e.g. `level`
- **Applicability:** AMWA IS-04
...
- **Specification:** per AMWA BCP-004-01
  - **Type:** string (enumerated values as per the [Sender Attributes](../sender-attributes/#packet-transmission-mode), [H.264 Sender Attributes](../sender-h264-attributes/#packet-transmission-mode), [H.265 Sender Attributes](../sender-h265-attributes/#packet-transmission-mode) registers)
...
- **Specification:** per AMWA BCP-004-01
  - **Type:** string (enumerated values as per the [H.264 Sender Attributes](../sender-h264-attributes/#parameter-sets-transport-mode), [H.265 Sender Attributes](../sender-h265-attributes/#parameter-sets-transport-mode) registers)
